...
On [NPM](https://www.npmjs.com/package/solandra).

Install with `pnpm add solandra`, `npm i solandra` or `yarn add solandra`.
...
/>
Alternatively, why not [create iOS 13+ style wallpapers with
Solandra](https://www.amimetic.co.uk/art/apple-style-wallpaper/)
...
/>
Create [watercolour style](https://www.amimetic.co.uk/art/watercolour) graphics
with Solandra.
