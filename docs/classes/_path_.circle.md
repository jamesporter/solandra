...
[Globals](../globals.md) / ["path"](../modules/_path_.md) / [Circle](_path_.circle.md) /
...
*Defined in [path.ts:486](https://github.com/jamesporter/solandra/blob/c698086/src/lib/path.ts#L486)*
